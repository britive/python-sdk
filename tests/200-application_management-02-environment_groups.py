...
def test_environment_group_list(cached_application):
    groups = britive.application_management.environment_groups.list(application_id=cached_application['appContainerId'])
...
def test_environment_group_get(cached_application, cached_environment_group):
    group_get = britive.application_management.environment_groups.get(
